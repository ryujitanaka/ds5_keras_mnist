...
/**************************************************************************//**
* Function Name: RZ_A1H_GENMAI_SetSramWriteEnable
...
/**************************************************************************//**
* Function Name: RZ_A1H_GENMAI_InitClock
* @brief         Initialize Board settings
*
*                Description:<br>
*                Initialize Clock
...
void RZ_A1H_GENMAI_InitClock(void)
{
    ...
    GPIO.PIBC0 |= (uint16_t)GPIO_PORT0_BOOTMODE_BITMASK;
    ppr0reg = GPIO.PPR0;
    ...
    {
        /* ClockMode1 */
        CPG.FRQCR  = 0x1335;    /* CPU Clock =128.00MHz */
        CPG.FRQCR2 = 0x0003;    /* G Clock   =128.00MHz */
    }
...
/**************************************************************************//**
* Function Name: RZ_A1H_GENMAI_IsClockMode0
...
/**************************************************************************//**
* Function Name: RZ_A1H_GENMAI_InitBus
