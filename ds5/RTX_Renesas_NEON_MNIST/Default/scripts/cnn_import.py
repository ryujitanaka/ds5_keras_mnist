...
def main():
    ...
    #--- load parameters ---
    lay0_params = loadParams(imgDir + '/scripts/mnist_cnn_train121_params_layer0.json')
    lay2_params = loadParams(imgDir + '/scripts/mnist_cnn_train121_params_layer2.json')
    lay6_params = loadParams(imgDir + '/scripts/mnist_cnn_train121_params_layer6.json')
    lay8_params = loadParams(imgDir + '/scripts/mnist_cnn_train121_params_layer8.json')

    #--- store parameters ---
    s_adr = 0x20650000    # NN_BUFFER
